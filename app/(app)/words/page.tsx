    ...
    <main className="container mx-auto px-4 py-8">
      ...
      <Tabs defaultValue="add-words" className="w-full">
        <TabsList className="mb-8">
          ...
          <TabsTrigger value="my-words">My Words</TabsTrigger>
        ...
        <TabsContent value="add-words">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="space-y-8">
              <div>
                <h2 className="text-xl font-semibold mb-4">Add Single Word</h2>
                <WordForm />
              </div>

              <div>
                <h2 className="text-xl font-semibold mb-4">Extract Words from Image</h2>
                <ImageWordExtractor />
              </div>
            </div>

            <div>
              <h2 className="text-xl font-semibold mb-4">Add Multiple Words</h2>
              <BulkWordAdder />
            </div>
          </div>
        </TabsContent>
        ...
        <TabsContent value="dictionaries">
          <div>
            <h2 className="text-xl font-semibold mb-4">Dictionary Subscriptions</h2>
